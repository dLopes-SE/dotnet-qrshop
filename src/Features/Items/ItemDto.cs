...
public sealed record ItemDto(int Id, string Name, string Slogan, string Description, ShopItemCategoryEnum type, string Image,  bool IsFeaturedItem, double Price)
{
