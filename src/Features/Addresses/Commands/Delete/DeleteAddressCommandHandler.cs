...
public class DeleteAddressCommandHandler(
  ...
  IOrderService _orderService) : ICommandHandler<DeleteAddressCommand>
{
  public async Task<Result> Handle(DeleteAddressCommand command, CancellationToken cancellationToken)
  {
    ...
    {
      return Result.Failure<int>(Error.Problem("There's a pending checkout", "Error removing address, please try again or contact the support"));
    }
